...
def run():
    ...
    inputs = {
        "participants": [
            "List of participants name and email, e.g. 'Akaki Khvedelidze <akhvedelidze@gmail.com>'"
        ],
        "company": "United Nation",
        "context": "Human Right",
        "objective": "Empower Human right world wide",
        "prior_interactions": "Save the date",
    }
